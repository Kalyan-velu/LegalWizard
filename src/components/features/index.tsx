...
import ScreenShot1 from "/assests/screenshot.png";
const Features = () => {
  const featuresData = [
    {
      id: 1,
      ...
      <div className=" m-auto grid gap-5 py-12 md:w-[80%]">
        {featuresData.map((item) => (
          <React.Fragment key={item.id}>
            <div className="xs:grid-cols-hero-md my-6 grid items-center gap-16 md:grid-cols-hero-lg md:justify-center">
              <div
                className={`${
              ...
              >
                ...
                <p className="gray-light text-left text-xl">{item.paragraph}</p>
              ...
              <div className="m-auto flex w-[70%] justify-center rounded-2xl bg-gradient-to-br from-midnight-blue-500 to-pink-500 md:m-0 md:block md:w-[100%]">
                <img
                  src={item.img_src}
                  alt="hero"
